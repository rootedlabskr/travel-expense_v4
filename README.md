...
<div class="main">
  ...
  <div class="page" id="page-add">
    ...
    <div class="card" id="scanCard">
      ...
      <div class="scan-zone" id="scanZone" onclick="document.getElementById('receiptFile').click()"
        ...
        <div id="scanPlaceholder">
          ...
          <div class="scan-sub">탭하여 촬영하거나 파일 선택 · AI가 자동으로 폼을 채워드려요</div>
        </div>
    ...
    <div class="card">
      <div class="card-title">지출 유형 선택</div>
    ...
    <div class="card" id="formCard">
      <div class="card-title">지출 상세</div>
      <div id="autofillBadge" style="display:none" class="notice" style="margin-bottom:10px">
        📷 영수증에서 자동 입력되었습니다. 내용을 확인하고 저장해주세요.
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label class="form-label">납부자 (누가 결제했나요?)</label>
        <select class="form-input" id="expPayer">
          <option value="">-- 멤버를 먼저 추가해주세요 --</option>
        </select>
      </div>
      <div class="form-group" id="personalMemberGroup">
      ...
      <button class="btn btn-primary" onclick="addExpense()">지출 추가하기</button>
    </div>
  </div>
  ...
  <div class="page" id="page-list">
    ...
    <button class="export-btn" onclick="exportCSV()">📥 CSV로 내보내기</button>
  </div>
...
function switchTab(tab) {
  ...
  const tabs = ['members','add','list','settle'];
...
const SHEET_URL = 'https://script.google.com/macros/s/AKfycbyIK0L_5h4dEGWnmbxV5oWQRVyjGXxLOn0B_Xj4EuPIGa7jKG8invnI_MbIuYdBcVc_YA/exec';
    ...
    <div class="expense-item">
      ...
      <div>
        ...
        <div style="text-align:right;margin-top:4px">
          <button class="btn btn-danger" onclick="deleteExpense(${e.id})">삭제</button>
        </div>
      </div>
    </div>
  `).join('');
